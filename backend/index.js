...
const CalendarEvent = require('./models/CalendarEvent'); // Make sure the file is named correctly

// ✉️ Configure Nodemailer (Email Sender)
...
//👨‍🎓 Tutor Creating Student
// 👨‍🏫 Tutor Creates a Student Account
